(defproject rems "2.32"
  ...
  {:uberjar {:omit-source true
             :prep-tasks [["shell" "sh" "-c" "mkdir -p target/uberjar/resources"]
                          ["shell" "sh" "-c" "echo 'v2.32-20-g783277a01-custom' > target/uberjar/resources/git-describe.txt"]
                          ["shell" "sh" "-c" "echo '783277a0135d714f4650da5b25311ee65d8fcdc7' > target/uberjar/resources/git-revision.txt"]
                          "javac"
                          "compile"
                          "shadow-release"]
             :aot :all
