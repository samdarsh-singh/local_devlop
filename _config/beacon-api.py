...
# Database connection
#
database_host = 'storage-mongo'
database_port = 27017
database_user = 'admin'
database_password = 'M0ngo.S3cr3t,P0wrd!'
...
idp_client_secret = 'VTzVhlxAFtE9ST6vNJ2ZK2Ic0s9UdU31>' # 'b26ca0f9-1137-4bee-b453-ee51eefbe7ba'  same as in the test IdP
idp_scope = 'profile openid'

idp_authorize = 'http://keycloak:8080/realms/GDIrealm/protocol/openid-connect/auth'
idp_access_token = 'http://keycloak:8080/realms/GDIrealm/protocol/openid-connect/token'
idp_introspection = 'http://keycloak:8080/realms/GDIrealm/protocol/openid-connect/token/introspect'
idp_user_info = 'http://keycloak:8080/realms/GDIrealm/protocol/openid-connect/userinfo'
idp_logout = 'http://keycloak:8080/realms/GDIrealm/protocol/openid-connect/logout'

idp_redirect_uri = 'http://beacon:8000/login'
